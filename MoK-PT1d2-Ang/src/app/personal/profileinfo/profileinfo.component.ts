...
constructor(private http: HttpClient, public userservice: UserService, private router: Router, public dashboardservice:DashboardService) { }
  ...
  ResetChange(){
    this.userservice.GetDataForLoggedInUser().subscribe(res => {
      ...
      this.DateVal = this.userservice.LoggedInUserInfo.DateOfBirth as Date;
      console.log(this.DateVal);
      console.log(this.DateVal.getDay);
    });
    ...
    if (this.validateForm()) {
      this.userservice.UpdateUserInformation().subscribe(res => {
        ...
        if (res.status == 200){
          ...
          console.log(this.dashboardservice.profileSelected);
